...
## Two-Site Strategy
- Site 1 (Wix): brand hub, education, SEO content
- Site 2 (WooCommerce): direct store with real checkout
- I'm building both improvements and the new site

## Key Decisions
- LLC name: PRC Labs LLC (neutral, won't flag banks) — **FILED ✅** via Tailor Brands
- Domain: prcpeptides.com on Namecheap ($6.79/yr with NEWCOM679) — available, not yet purchased
