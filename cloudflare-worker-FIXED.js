  ...
  async fetch(request, env) {
    ...
    if (url.pathname === '/bankful/callback' && request.method === 'POST') {
      try {
        ...
        // Telegram notification handled by Apps Script to avoid duplicates from Bankful retries
    ...
    if (url.pathname === '/order' && request.method === 'POST') {
      try {
        ...
        // Telegram notification handled by Apps Script (not Worker)
        // Worker only sends payment approval/decline notifications
